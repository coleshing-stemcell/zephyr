...
The Zephyr nucleo_g491re board configuration supports the following hardware features:
...
:zephyr_file:`boards/st/nucleo_g491re/nucleo_g491re_defconfig`
...
Nucleo G491RE board has 3 U(S)ARTs. The Zephyr console output is assigned to LPUART1.
